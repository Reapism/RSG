...
namespace RSG.Core.Interfaces.Services
{
    ...
    public interface IDictionaryLoader
    {
        ...
        Task SelectAsync(string dictionaryName, CancellationToken cancellationToken);
        ...
        Task<RsgDictionary> GetSelectedDictionaryAsync(CancellationToken cancellationToken);
    }
}