    ...
    public class StringEditViewModel : ViewModelBase
    {
        ...
        public string CharacterList
        {
            ...
            set
            {
                ...
                foreach (var kvp in stringConfiguration.CharacterSets)
                {
                    if (kvp.Enabled)
                    {
                        ...
                        stringConfiguration.CharacterSets.Add(new CharacterSet($"NewSet{characterSetToAdd}", characterSetToAdd, true));
                    }
                }
            }
        }
